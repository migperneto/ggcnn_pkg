...
O campo potencial artificial é determinado pelo arquivo "potential_field.py"
...
timestamp = []  # Inicializa a variável global para o tempo de execução
...
def generate_path():
    ...
    potential_field = PotentialField(k_att, k_rep, rho_0, step_size)   # Criando o objeto "potential_field"
...
def move_ur5_to_pose(path):
    ...
    start_time = None  # Variável auxiliar para iniciar o tempo de execução em zero 
    global timestamp  # Variável que vai armazenar o tempo transcorrido na trajetória
    ...
    for i,point in enumerate(path):
        ...
        # Calcula o instante de tempo do movimento
        elapsed_time = time.time() - start_time
        # Armazena os instantes de tempo transcorrido
    ...
    # rospy.loginfo(f'Tempo transcorrido: {timestamp}')
...
if __name__ == '__main__':
    try:
        ...
        # his_forces = potential_field.forces_hist()
        # print(his_forces[0])
